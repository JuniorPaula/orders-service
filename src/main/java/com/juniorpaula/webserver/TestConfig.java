...
public class TestConfig implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
    ...
    Order o1 = new Order(null, Instant.parse("2025-02-02T15:42:07Z"), u1);
    Order o2 = new Order(null, Instant.parse("2025-02-03T15:42:07Z"), u2);
    Order o3 = new Order(null, Instant.parse("2025-02-04T15:42:07Z"), u1);
